            ...
            {submitSuccess ? (
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 font-bold mb-4">
                  Hệ thống sẽ chạy thử nghiệm chấm chéo tự động với 20 mẫu tiêu chuẩn từ Kaggle (5 mẫu mỗi cử chỉ) để đánh giá chất lượng mô hình của bé.
                </p>
