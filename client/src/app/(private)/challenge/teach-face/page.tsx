...
export default function TeachFacePage() {
  ...
  const handleOpenSubmit = () => {
    ...
    // Leave-One-Out Cross Validation (LOOCV) on user's own samples
    // For each sample: remove it, classify it with remaining samples, check if correct
    let correctCount = 0;
    ...
    let calculatedAccuracy = samples.length > 0
      ? Math.round((correctCount / samples.length) * 100)
      : 0;
